...
from services.memory_manager import RAGMemoryManager
import logging
...
class RAGSystem:
    ...
    def setup_router(self):
        ...
        router_prompt = ChatPromptTemplate.from_messages([
            ...
            ("human", "Given the following conversation history, determine the appropriate data source to route the query to. The query is the last message in the conversation history.\n\nConversation History:\n{messages}\n")
        ])
